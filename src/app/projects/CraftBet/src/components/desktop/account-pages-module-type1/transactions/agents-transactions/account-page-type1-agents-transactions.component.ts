...
@Component({
  ...
  templateUrl: './account-page-type1-agents-transactions.component.html',
  styleUrl: './account-page-type1-agents-transactions.component.scss'
})
export class AccountPageType1AgentsTransactionsComponent extends AppCommonTransactionsComponent {
