...
@Component({
    ...
    templateUrl: './ussd-pin.component.html',
    styleUrls: ['./ussd-pin.component.scss']
})
export class UssdPinComponent implements OnInit {
    formGroup: FormGroup;
    profileData: any;
    ...
    saveUssdPin() {
        ...
        {
            this.verificationService.getVerificationCode('mobile', VerificationCodeTypes.USSDPinChangeByMobile).subscribe((responseData) => {
