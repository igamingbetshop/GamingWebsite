...
@Component({
  selector: 'app-account-page-type3-history',
  templateUrl: './account-page-type3-history.component.html',
  styleUrls: ['./account-page-type3-history.component.scss']
})
export class AccountPageType3HistoryComponent extends AppCommonBetsHistoryComponent {
