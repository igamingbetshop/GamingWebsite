...
@Injectable()
export class BaseWithdrawType16Component extends BaseWithdrawPaymentComponent {
    ...
    selectBank(bankId: any) {
        this.bankType = bankId;
        this.accounts = this.banks.find(bank => bank.Branches[0] == bankId)?.Accounts;
    }
